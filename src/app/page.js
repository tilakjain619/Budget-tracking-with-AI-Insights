  ...
  return (
    <div>
      <section className="grid sm:flex justify-around min-h-[85vh] items-center">
        ...
        <img src="./main-header.png" className="sm:mt-0 hidden sm:block w-full h-40 sm:h-full object-cover object-center sm:w-4/12 rounded-xl" alt="Dashboard Pic" />
      </section>
      ...
      <div className="text-center grid gap-2 sm:gap-4 text-balance">
          ...
          <p className="text-gray-300 md:max-w-2xl md:mx-auto text-sm sm:text-lg">See what our community has to say about their experience with SmartTrack.</p>
        <Reviews/>
        </div>
      </section>
    </div>
