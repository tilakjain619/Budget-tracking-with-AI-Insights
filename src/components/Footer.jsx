    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="pt-7 flex flex-col min-[520px]:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <a href="javascript:;"
            className="border border-gray-300 p-2 rounded-full aspect-square text-gray-400 transition-all duration-300 hover:text-indigo-600 hover:border-indigo-600 focus-within:outline-0 focus-within:text-indigo-600 focus-within:border-indigo-600">
